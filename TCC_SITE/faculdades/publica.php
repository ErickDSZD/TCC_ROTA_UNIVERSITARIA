...
<head>
    ...
    <title>Faculdades Públicas - Rota Universitária</title>
...
<body>
    ...
    <main class="corpo_main">
        <h2>AQUI ESTÁ UMA LISTA DE FACULDADES PÚBLICAS:</h2>

        <?php
        // Consulta SQL para selecionar as faculdades onde "PUBLICA" é igual a 1
        $sql = "SELECT * FROM faculdade WHERE PUBLICA = 1";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "Nenhuma faculdade pública encontrada.";
        }
